...
<head>
    ...
    <title>Pelayanan Surat Keterangan Online Desa Kerjo Lor</title>
    <!-- core CSS -->
...
<body id="home" class="homepage">
        ...
        <nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img src="main/img/logokerjolor.png" width="150" height="65" alt="logo"></a>
                </div>
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="scroll"><a href="pegawai.php">Login Pegawai</a></li>
    ...
    <section id="cta2">
        <div class="container">
            <div class="text-center">
                <h2 class="wow fadeInUp" data-wow-duration="200ms" data-wow-delay="0ms"><span>PELAYANAN</span> SURAT KETERANGAN <br> KANTOR DESA KERJO LOR</h2>
    ...
    <section id="features">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">JADWAL PELAYANAN</h2>
            </div>
            <div class="row">
                ...
                <div class="features">
                    <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                ...
                                <p>Pemohon Surat melakukan login, melalui halaman Login. Jika belum punya akun, silahkan daftar terlebih dahulu.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="100ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Melengkapi Biodata</h4>
                                <p>Lengkapi biodata pemohon setelah melakukan Login dengan username dan password, sebelum melakukan request surat.</p>
                            </div>
                        </div>
                    </div>
                    <!--/.col-md-4-->
                    ...
                    <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                ...
                                <p>Permohonan di setujui oleh Kepala Desa, kemudian staf akan mengirimkan surat sesuai request surat yang diajukan, pemohon mencetak surat secara mandiri atau mengambil surat yang sudah dicetak di Kantor Desa Kerjo Lor.</p>
                            </div>
                        </div>
                    </div>
                    <!--/.col-md-4-->
    ...
    <section id="contact">
        <div>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3952.7168611643256!2d111.03058597415578!3d-7.819764677656098!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a291241f0e941%3A0x7a5a10857cbea8c7!2sKantor%20Kepala%20Desa%20Kerjo%20Lor!5e0!3m2!1sid!2sid!4v1754415237673!5m2!1sid!2sid"  width="100%" height="650px" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0" alt="lokasi Kantor Desa"></iframe>
        </div>
    </section>
    <!--/#bottom-->
    ...
    <footer id="footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; <?php echo date('Y');?> KANTOR DESA KERJO LOR
                </div>
                <div class="col-sm-6">
                    <ul class="social-icons">
                        <li><a href="https://www.instagram.com/desa_kerjolor/" target="_blank"><i class="fa fa-instagram"></i></a></li>
                        <li><a href="https://www.facebook.com/kerjolormaju.kerjolormaju" target="_blank"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="https://www.youtube.com/@desakerjolorwonogiri" target="_blank"><i class="fa fa-youtube"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
