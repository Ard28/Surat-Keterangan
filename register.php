<?php 
  ...
  $maxDate = date('Y-m-d', strtotime('-17 years'));
...
<body>
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo">
                <img src="main/img/logokerjolor.png" width="150" height="65" alt="logo">
              </div>
              ...
              <form method="POST" class="pt-3">
                ...
                <div class="form-group">
                  <input type="date" name="tgl" class="form-control form-control-lg" max="<?php echo $maxDate; ?>" required>
                </div>
                <div class="form-group">
                ...
                <div class="mt-3">
                  <a class="btn btn-block btn-danger btn-lg font-weight-medium auth-form-btn" href="http://localhost/surat-kerjolor/">BATAL</a>
                </div>
  ...
  <script>
  // Validasi umur via JavaScript juga
  document.querySelector('input[name="tgl"]').addEventListener('change', function() {
